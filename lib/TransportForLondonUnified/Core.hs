...
-- * TransportForLondonUnifiedConfig

-- | 
data TransportForLondonUnifiedConfig = TransportForLondonUnifiedConfig
...
-- | display the config
instance P.Show TransportForLondonUnifiedConfig where
  show c =
    T.printf
...
-- | constructs a default TransportForLondonUnifiedConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"transport-for-london-unified/0.1.0.0"@
--
newConfig :: IO TransportForLondonUnifiedConfig
newConfig = do
...
addAuthMethod :: AuthMethod auth => TransportForLondonUnifiedConfig -> auth -> TransportForLondonUnifiedConfig
addAuthMethod config@TransportForLondonUnifiedConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: TransportForLondonUnifiedConfig -> IO TransportForLondonUnifiedConfig
...
withStderrLogging :: TransportForLondonUnifiedConfig -> IO TransportForLondonUnifiedConfig
...
withNoLogging :: TransportForLondonUnifiedConfig -> TransportForLondonUnifiedConfig
withNoLogging p = p { configLogExecWithContext =  runNullLogExec}
 
-- * TransportForLondonUnifiedRequest
...
data TransportForLondonUnifiedRequest req contentType res accept = TransportForLondonUnifiedRequest
  { rMethod  :: NH.Method   -- ^ Method of TransportForLondonUnifiedRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of TransportForLondonUnifiedRequest
  , rParams   :: Params -- ^ params of TransportForLondonUnifiedRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (TransportForLondonUnifiedRequest req contentType res accept) NH.Method
rMethodL f TransportForLondonUnifiedRequest{..} = (\rMethod -> TransportForLondonUnifiedRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (TransportForLondonUnifiedRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f TransportForLondonUnifiedRequest{..} = (\rUrlPath -> TransportForLondonUnifiedRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (TransportForLondonUnifiedRequest req contentType res accept) Params
rParamsL f TransportForLondonUnifiedRequest{..} = (\rParams -> TransportForLondonUnifiedRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (TransportForLondonUnifiedRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f TransportForLondonUnifiedRequest{..} = (\rAuthTypes -> TransportForLondonUnifiedRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => TransportForLondonUnifiedRequest req contentType res accept -> param -> TransportForLondonUnifiedRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: TransportForLondonUnifiedRequest req contentType res accept -> param -> TransportForLondonUnifiedRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: TransportForLondonUnifiedRequest req contentType res accept -> param -> TransportForLondonUnifiedRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** TransportForLondonUnifiedRequest Utils

_mkRequest :: NH.Method -- ^ Method 
          -> [BCL.ByteString] -- ^ Endpoint
          -> TransportForLondonUnifiedRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = TransportForLondonUnifiedRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader :: TransportForLondonUnifiedRequest req contentType res accept -> [NH.Header] -> TransportForLondonUnifiedRequest req contentType res accept
setHeader req header =
  req `removeHeader` P.fmap P.fst header &
  L.over (rParamsL . paramsHeadersL) (header P.++)

removeHeader :: TransportForLondonUnifiedRequest req contentType res accept -> [NH.HeaderName] -> TransportForLondonUnifiedRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => TransportForLondonUnifiedRequest req contentType res accept -> TransportForLondonUnifiedRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of 
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => TransportForLondonUnifiedRequest req contentType res accept -> TransportForLondonUnifiedRequest req contentType res accept
_setAcceptHeader req =
    case mimeType (P.Proxy :: P.Proxy accept) of 
        Just m -> req `setHeader` [("accept", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["accept"]

setQuery :: TransportForLondonUnifiedRequest req contentType res accept -> [NH.QueryItem] -> TransportForLondonUnifiedRequest req contentType res accept
setQuery req query = 
  req &
  L.over
...
addForm :: TransportForLondonUnifiedRequest req contentType res accept -> WH.Form -> TransportForLondonUnifiedRequest req contentType res accept
addForm req newform = 
...
_addMultiFormPart :: TransportForLondonUnifiedRequest req contentType res accept -> NH.Part -> TransportForLondonUnifiedRequest req contentType res accept
...
_setBodyBS :: TransportForLondonUnifiedRequest req contentType res accept -> B.ByteString -> TransportForLondonUnifiedRequest req contentType res accept
_setBodyBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: TransportForLondonUnifiedRequest req contentType res accept -> BL.ByteString -> TransportForLondonUnifiedRequest req contentType res accept
_setBodyLBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => TransportForLondonUnifiedRequest req contentType res accept -> P.Proxy authMethod -> TransportForLondonUnifiedRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    :: TransportForLondonUnifiedConfig
    -> a
    -> TransportForLondonUnifiedRequest req contentType res accept
    -> IO (TransportForLondonUnifiedRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> TransportForLondonUnifiedConfig
  -> IO (TransportForLondonUnifiedRequest req contentType res accept)
_applyAuthMethods req config@(TransportForLondonUnifiedConfig {configAuthMethods = as}) =
  foldlM go req as
  where
