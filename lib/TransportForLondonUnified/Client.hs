...
module TransportForLondonUnified.Client where
...
dispatchLbs
  ...
  -> TransportForLondonUnifiedConfig -- ^ config
  -> TransportForLondonUnifiedRequest req contentType res accept -- ^ request
