...
module TransportForLondonUnified.MimeTypes where
...
data MimeGeojson = MimeGeojson deriving (P.Typeable)

-- | @application/geo+json@
instance MimeType MimeGeojson where
  mimeType _ = Just $ P.fromString "application/geo+json"
instance A.ToJSON a => MimeRender MimeGeojson a where mimeRender _ = A.encode
instance A.FromJSON a => MimeUnrender MimeGeojson a where mimeUnrender _ = A.eitherDecode
-- instance MimeRender MimeGeojson T.Text where mimeRender _ = undefined
-- instance MimeUnrender MimeGeojson T.Text where mimeUnrender _ = undefined
